 ...
 * 1. Whether this is the owner's first login (no Members rows → setup flow).
 * 2. The user's role by reading the Members tab and matching by email.
 *
...
/**
 * Resolves the role for a given email by reading the Members tab.
...
/**
 * Returns true if the Members tab has no data rows — meaning no owner has set up
