...
import { generateReceiptText, generateWhatsAppLink, generateReceiptNumber } from './receipt.service'
...
const items: TransactionItem[] = [
  { id: 'i1', transaction_id: 'tx-1', product_id: 'p1', variant_id: null, name: 'Nasi Goreng', price: 15000, quantity: 2, subtotal: 30000 },
  { id: 'i2', transaction_id: 'tx-1', product_id: 'p2', variant_id: null, name: 'Es Teh Manis', price: 5000, quantity: 1, subtotal: 5000 },
]
...
describe('generateReceiptText', () => {
  ...
  it('does not include kembalian line for QRIS transactions', () => {
    const qrisTx = { ...transaction, payment_method: 'QRIS' as const, cash_received: 38850, change: 0 }
  ...
  it('includes discount line when discount_amount > 0', () => {
    const discountTx = { ...transaction, discount_type: 'percent' as const, discount_value: 10, discount_amount: 3500 }
