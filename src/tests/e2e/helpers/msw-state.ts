...
function buildFixtureMap(
  ...
  const tableToSpreadsheetId: Record<TableName, string> = {
    ...
    Settings: store.masterSpreadsheetId,
    Members: store.masterSpreadsheetId,
    Categories: store.masterSpreadsheetId,
    Products: store.masterSpreadsheetId,
    Variants: store.masterSpreadsheetId,
    Customers: store.masterSpreadsheetId,
    Purchase_Orders: store.masterSpreadsheetId,
    Purchase_Order_Items: store.masterSpreadsheetId,
    Stock_Log: store.masterSpreadsheetId,
    Audit_Log: store.masterSpreadsheetId,
    Monthly_Sheets: store.masterSpreadsheetId,
    Transactions: store.monthlySpreadsheetId,
    Transaction_Items: store.monthlySpreadsheetId,
    Refunds: store.monthlySpreadsheetId,
  };
